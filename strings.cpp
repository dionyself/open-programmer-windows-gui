...
//	#endif
	...
	strings_it[S_DevMismatch]="Attenzione: il dispositivo ̬ diverso da quello specificato nei dati" NL;
	...
	strings_it[S_FWver2old]="Questo firmware ̬ troppo vecchio. E' richiesta la versione %s" NL;
